...
(function($) {
  ...
  const presets = [
		{
			"description": "",
			"id": "c07953db-89f5-4caa-94d4-051f43f8b7e9",
			"value": "url('#dark-blue-sepia')",
			"values": [
				{
					"url": "url('#dark-blue-sepia')"
				}
			]
		},
		{
			"description": "",
			"id": "01b49b04-001f-467c-991a-280f14356eae",
			"value": "url('#warm-sea')",
			"values": [
				{
					"url": "url('#warm-sea')"
		...
		},
		{
			"description": "",
			"id": "01b49b04-001f-467c-991a-280f14356eae",
			"value": "url('#spring-grass')",
			"values": [
				{
					"url": "url('#spring-grass')"
				}
			]
		},
  {
